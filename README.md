...
<h6 align="center"> This bot is not actively maintaned anymore due to the api changes of discord back in 2022 where slash commands were mandated to be mandatorily used for any verified bot - i might bother restarting development if it's realistically possible to conver all functionality over to slash commands - untill then it's mostly a public code archive for anyone willing to copy code from this codebase</h6>
